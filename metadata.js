module.exports = {
  site: {
    title: 'ColorSnapper',
    description:
      'The macOS <em>color picker</em> app for designers <span class="amp">&amp;</span> developers which makes it easy to <em>collect</em>, <em>adjust</em>, <em>organize</em> and <em>export</em> colors of <em>any pixel</em> on the screen.',
    keywords:
